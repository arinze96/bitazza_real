...
<body>
            ...
            <div class="row">
                <div class="fun-content">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <!-- fun_text  -->
                        <div class="fun_text" style="background-color:#333333">
        ...
        <div class="container" style="overflow: scroll;">
            ...
            <div class="tradingview-widget-container">
                ...
                <div class="tradingview-widget-copyright"><a href="https://www.tradingview.com/markets/"
                        rel="noopener" target="_blank"><span class="blue-text">Financial Markets</span></a> by
                    TradingView</div>
    ...
    <div id="coinmarketcap-widget-marquee" coins="1,1027,825,1839,2010,3408" currency="USD" theme="dark"
                                ...
                                <div class="single-proses">
                                    <div class="proses-content">
                                        ...
                                        <div class="proses-text">
                                            <h4 style="color:#fff">Refferal bonus of 5% on each refferal</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="single-testi">
                                    <div class="testi-text">
                                        ...
                                        <div class="testi-img ">
                                            ...
                                            <div class="guest-details">
                                                <h4 style="color: #fff">Gabriel Hank</h4>
                                                <span class="guest-rev" style="color: #fff">Client- <a href="#">
                                                    </a></span>
                                            </div>
                                        </div>
                                    </div>
